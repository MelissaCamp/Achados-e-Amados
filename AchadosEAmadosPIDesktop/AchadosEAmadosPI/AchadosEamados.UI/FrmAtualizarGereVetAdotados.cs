...
{
    public partial class FrmAtualizarGereVetAdotados : Form
    {
        AdotadoDTO adotadoDTO = new AdotadoDTO();
        AdotadoBLL adotadoBLL = new AdotadoBLL();
        public FrmAtualizarGereVetAdotados()
        {
            InitializeComponent();
        }
        ...
        private void FrmAtualizarGereVetAdotados_Load(object sender, EventArgs e)
        {
