...
namespace AchadosEamados.UI
{
    ...
    public partial class FrmListarAnimaisAdotadoCuidador : Form
    {
        AdotadoDTO adotadoDTO = new AdotadoDTO();
        AdotadoBLL adotadoBLL = new AdotadoBLL();
        public FrmListarAnimaisAdotadoCuidador()
        {
            InitializeComponent();
        }

        private void FrmListarAnimaisAdotadoCuidador_Load(object sender, EventArgs e)
        {
